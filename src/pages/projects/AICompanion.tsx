...
const projectContent = [{
  ...
  description: "Last summer, TikTok in Vietnam was overflowing with astrology content. I noticed that my friends were paying a lot of money to see astrology readers, because there were no astrology reading app in Vietnamese.\n\nWhen investigated further, I found that there was no Vietnamese astrology API for developers to leverage building.  That gap felt like the perfect opportunity. So, using Cursor, I set out to build my first project—a Vietnamese astrology app.\n\nI also notice that most astrology apps are pretty passive: open, read, close. That's not how a real reading feels. Real readings are conversations—follow-ups, context, what-if questions. With modern LLMs, I saw an opportunity to utilize AI to replicate the experience of talking with an actual \"astrologer\" any time without awkward scheduling or high session fees.",
