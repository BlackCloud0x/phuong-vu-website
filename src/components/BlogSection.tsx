...
const BlogSection = () => {
  return <section id="blog" className="py-20 px-6 relative bg-background">
      <div className="container mx-auto max-w-4xl relative z-10">
        ...
        <div className="space-y-12">
          ...
          return <article key={post.id} className="group cursor-pointer glass-card p-8 rounded-2xl hover:bg-white/10 transition-smooth">
