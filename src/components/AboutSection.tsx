...
const AboutSection = () => {
  return <section id="about" className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 relative bg-background">
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8 items-start justify-center max-w-5xl mx-auto">
          {/* Avatar */}
          ...
          {/* About Content */}
          <div className="glass-card p-6 sm:p-8 rounded-xl sm:rounded-2xl flex-1 min-h-[200px] flex flex-col justify-center">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-foreground mb-4 sm:mb-6">About Me</h2>
            ...
            <div className="mt-6 sm:mt-8">
              ...
              <div className="flex flex-wrap gap-2 sm:gap-3">
                {["React", "TypeScript", "Node.js", "Product Strategy", "UI/UX Design"].map((skill) => (
                  <span key={skill} className="px-3 sm:px-4 py-2 bg-primary/20 text-primary border border-primary/30 rounded-full text-sm font-medium backdrop-blur-sm">
                    {skill}
                  </span>
                ))}
              </div>
